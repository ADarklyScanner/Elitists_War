...
${app('victory is not declared by hand yet: after every turn\'s end-of-turn window, the app checks every live player and anyone who meets a Goal at that moment is treated as declaring. The end-of-turn window is where you can play the cards that stop or secure a win. A stricter, hand-declared procedure matching the steps above is being added. Goal cards in hand are checked automatically, the Goal-card limit is enforced at all times, and no more than three Groups ever count double. The optional Quick game is a house rule that lowers the Basic Goal to 8.')}
`,
  },
  {

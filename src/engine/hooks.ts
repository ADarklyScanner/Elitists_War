...
export interface CardHooks {
   ...
   * token placement phase), whoever controls the card (Martyr Meter, Dokstok, S.L.A.K.); also ends effects
   * that lasted only while the tokens were placed (Strange Bedfellows).
   */

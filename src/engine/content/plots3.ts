...
/**
 * Plots that deal with Computers (Computer Security): every Plot whose printed cost or effect names
 * Computer Groups (Computer Virus, Gremlins, Infobahn, The Auditor From Hell, The Internet Worm,
